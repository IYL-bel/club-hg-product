 ...
 * Send Email service
 *
 * @package    ApplicationMessageBundle
...
/**
 * Application\MessageBundle\Service\SendEmailService
 */
class SendEmailService
{
    ...
    /**
     * @param \Application\UsersBundle\Entity\Users|string $to
    ...
    {
        $messageSettings = $this->container->getParameter('application_message.settings');
        ...
        if ( is_object($to) ) {
            if ($to instanceof Users) {
                ...
                $user = $to;
                call_user_func_array( array($message, 'setTo'), array($user->getEmail(), $user->getFirstName() ) );
            } else {
